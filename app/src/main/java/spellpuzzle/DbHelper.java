...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE SPELL (ID TEXT PRIMARY KEY, ENCODED_PHRASE TEXT, SOLUTION_PHRASE TEXT)";
    ...
    private static final String SQL_CREATE_PLAYER_RATINGS =
            "CREATE TABLE PLAYERRATINGS (USERNAME TEXT PRIMARY KEY, FIRSTNAME TEXT, LASTNAME TEXT, NUM_SPELLS_SOLVED INTEGER,"
            + " NUM_SPELLS_STARTED INTEGER, NUM_INCORRECT_SOLUTIONS INTEGER)";
    private static final String SQL_CREATE_SPELL_FOR_PLAYERS =
            "CREATE TABLE SPELLFORPLAYERS (ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "
            + "SPELL_ID INTEGER, USERNAME TEXT, CURRENT_SOLUTION TEXT, "
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(SQL_CREATE_SPELL_FOR_PLAYERS);
    }
